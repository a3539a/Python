...
print("dic1[101][1] : ", dic3[101][1])
print("dic1[101][4] : ", dic3[101][4])
print("dic1[102][3] : ", dic3[102][3])
print("dic1[103] : ", dic3[103])
print("dic1[104][p1] : ", dic3[104]['p1'])

# 응용
dics = [dic1, dic2, dic3]
# Exam) 대구 Aplle 김춘추를 찾아라.
